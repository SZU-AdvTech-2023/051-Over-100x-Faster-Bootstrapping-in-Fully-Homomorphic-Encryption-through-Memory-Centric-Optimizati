...
class Context {
 ...
 public:
  ...
  void Rotate(const Ciphertext&, const Ciphertext&, Ciphertext&) const;
  ...
  void rotate(const Ciphertext &ct, const EvaluationKey &evk,int sn,Ciphertext &out) const;
  void FrobeniusMap(DeviceVector &in,int sn,DeviceVector &out,DeviceVector &d_index) const;
